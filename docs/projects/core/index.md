...
::: info 文档对应版本
本轮使用说明按 2026-09-09 的 [main 提交 50322956](https://github.com/zerodenet/core/tree/503229562ef5854e3be6be3a9c8e7cbc5efffc61)核对。已公开 [v0.0.1 正式版](https://github.com/zerodenet/core/releases/tag/v0.0.1)；源码、发布与安装验收范围见[实现与文档进度](/progress)。实际能力以所用制品及运行时响应为准。
:::
