...
| 文档 | 对应源码 | 内容 |
|------|---------|------|
| [inbound.md](/projects/core/protocols/socks5/inbound) | `inbound.rs` | SOCKS5 CONNECT 入站、UDP ASSOCIATE 入站 |
| [outbound.md](/projects/core/protocols/socks5/outbound) | `outbound.rs` | 上游 SOCKS5 CONNECT / UDP ASSOCIATE 出站 |
| [shared.md](/projects/core/protocols/socks5/shared) | `shared.rs` | 认证协商、地址编码、UDP 包构建/解析 |
