...
| 文档 | 对应源码 | 内容 |
|------|---------|------|
| [inbound.md](/projects/core/protocols/shadowsocks/inbound) | `inbound.rs` | `ShadowsocksInbound`、`ShadowsocksAccept`、零拷贝入口、TCP/UDP 入站 |
| [outbound.md](/projects/core/protocols/shadowsocks/outbound) | `outbound.rs` | `ShadowsocksOutbound`、`ShadowsocksOutboundSession`、UDP packet framing、配置示例 |
| [shared.md](/projects/core/protocols/shadowsocks/shared) | `shared.rs` | `CipherKind`、密码规则、HKDF-SHA1 / Blake3 密钥派生、地址编码 |
| [stream.md](/projects/core/protocols/shadowsocks/stream) | `stream.rs` | `ShadowsocksAeadStream`、chunk 加解密、response salt |
| [metadata.md](/projects/core/protocols/shadowsocks/metadata) | `metadata.rs` | `ShadowsocksProtocol` 能力描述符、feature gate、limitations |
