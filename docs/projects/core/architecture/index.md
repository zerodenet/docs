...
- [协议能力](/projects/core/reference/protocol-capabilities)
- [执行计划](https://github.com/zerodenet/core/blob/develop/docs/project/engine-plan.md)
- [生命周期](/projects/core/architecture/lifecycle)
- [配置](/projects/core/configuration/)
- [控制面](https://github.com/zerodenet/core/blob/develop/docs/project/control-plane.md)
- [工程规则](https://github.com/zerodenet/core/blob/develop/docs/project/tooling.md)
