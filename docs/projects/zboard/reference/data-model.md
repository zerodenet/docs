...
Scope and future extension ownership follow the [core and hardening baseline](/projects/zboard/reference/core-baseline).
The models below describe existing storage and compatibility constraints, not a
requirement to expand core commerce. Preserve historical orders and entitlements
during incremental hardening; future payment integrations belong to plugins.
